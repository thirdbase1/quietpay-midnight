...
import { ledger, type Ledger, State } from '../../contract/src/managed/quietpay/contract/index.js';
...
import { QuietPayPrivateState } from '../../contract/src/witnesses.js';
      ...
      try {
        switch (choice) {
          case '1': {
            ...
            await quietpayApi.post(message);
            break;
          }
          case '2':
            await quietpayApi.takeDown();
            break;
          case '3':
